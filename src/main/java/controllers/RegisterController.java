...
public class RegisterController {
	...
	private void handleBtnRegistrarse() throws IOException {
		if (txtPassword.getText().isEmpty() || txtCorreo.getText().isEmpty() || txtUsuario.getText().isEmpty()) {
			Alert alert = new Alert(AlertType.WARNING);
			alert.setTitle("Error");
			alert.setHeaderText(null);
			alert.setContentText("Hay campos vacíos.");
			alert.showAndWait();
		} else if (cbGenero.getSelectionModel().getSelectedItem() == null || cbGenero.getSelectionModel().getSelectedItem().equals("Seleccione una opción")) {
                Alert alert = new Alert(AlertType.WARNING);
				alert.setTitle("Error");
				alert.setHeaderText(null);
			...
			if (txtPassword.getText().equals(txtPasswordRepeat.getText())) {
				;
				UsuarioDAO.newUser(txtUsuario.getText(), txtCorreo.getText(), txtPassword.getText(), Utils.getIDByGenre(cbGenero.getSelectionModel().getSelectedItem()));
